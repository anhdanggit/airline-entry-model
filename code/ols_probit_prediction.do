...
Author:          Hoang TRAN
Date:              27/04/2018
Description:   OLS - Probit Prediction
Source:	       "$path\airline_entry_model\data"
Input:			   markets_wide_new.csv; markets_long_new.csv 
*******************************************************************************/
...
import delimited "markets_wide_new.csv"
...
*********************************************
clear all 
import delimited "markets_long_new.csv"
